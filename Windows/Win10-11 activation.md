1. Run Command Prompt app as administrator(run it with admin rights)
2. Install KMS client key<br>
command “slmgr /ipk kmsclientkey”
````bash
...
````
3. Set KMS server(ping before set)
````bash
slmgr /skms s8.uk.to
````
